...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-5 py-10 md:py-16">
      <div className="w-full max-w-[460px]">
        ...
        <p className="text-ink/40 text-center mb-8 text-sm">
          Get started with JumuaPlanner in seconds
        </p>
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-[10px] text-ink/30 font-semibold uppercase tracking-wider">or</span>
          <div className="flex-1 h-px bg-line" />
        </div>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-5">
          <div>
            <label className="text-xs font-semibold text-ink/50 block mb-2">Full name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="text-xs font-semibold text-ink/50 block mb-2">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="text-xs font-semibold text-ink/50 block mb-2">Password</label>
            <input
              type="password"
              value={password}
