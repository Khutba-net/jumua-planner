...
export async function GET() {
  ...
  const user = db.prepare("SELECT id, name, email, account_type, role, organization_id, avatar_url, bio, phone, onboarding_complete, planning_year, created_at FROM users WHERE id = ?").get(userId) as Record<string, unknown> | undefined;
