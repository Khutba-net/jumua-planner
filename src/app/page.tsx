...
const t = {
  ...
  ar: {
    ...
    whatHelps: "كل ما تحتاجه لتخطيط عامك",

    obj1Title: "الغرض الأول · التخطيط",
    obj1Text: <><strong>{"خطِّط عامك كاملاً في جلسة واحدة."}</strong><br />{"يقسم النظام عامك إلى "}<span className="font-semibold text-primary">4</span>{" فصول، "}<span className="font-semibold text-primary">3</span>{" أشهر أو "}<span className="font-semibold text-primary">13</span>{" أسبوعاً لكل فصل. تسمّي لكل فصل "}<strong>عنواناً رئيسياً</strong>{"، وتختار تحته "}<span className="font-semibold text-primary">4</span>{" "}<strong>باقات فرعية</strong>{"، ثم تسمّي "}<span className="font-semibold text-primary">4</span>{" خطب تحت كل باقة. والعيد وسائر المناسبات الهجرية قلّ أن تقع يوم جمعة؛ فتأخذ خطبها موضعها في الخطة في أي يوم وقعت فيه، أسبوعياً كان أو في نهاية الأسبوع."}</>,
    obj1Result: <>{"= "}<span className="font-semibold text-primary">64</span>{" خطبة في السنة، نحو "}<span className="font-semibold text-primary">13</span>{" جمعة لكل عنوان رئيسي، بالإضافة إلى خطب المناسبات في أي يوم."}</>,
    ...
    obj2Text: <><strong>{"اكتُبها، ثم ألقِها بغير ورقة."}</strong><br />{"تحملك "}<strong>نافذة الخطبة</strong>{" على توثيق محتوى كل خطبة وضبطها في حدود "}<span className="font-semibold text-primary">15</span>{" إلى "}<span className="font-semibold text-primary">20</span>{" دقيقة؛ وهو قيدٌ واقعي في البلدان التي لا تعطّل الدوام يوم الجمعة وتحدّد للعاملين فسحةً معلومة للخروج والعودة."}<br /><br />{"ثم تتدرّب على إلقائها بغير ورقة: معدٌّ في المعنى، متحرّرٌ من النص. بهذا يتمكّن الخطيب من خطبته، وتبلغ خطبته من سامعها."}</>,
    obj2Link: "جرّب المحرر",
    editorWrite: "اكتب المحتوى كاملاً",
    editorWriteSub: "توثيق كل خطبة بالعربية والإنجليزية.",
    editorTarget: "استهدف 15–20 دقيقة",
    ...
    orgF2: "حتى 10 حسابات خطباء",
    orgF3: "أدوات مراجعة المشرف",
    orgF4: "بنك خطب مشترك",
    institution: "أوقاف",
    instPrice: "بالاتفاق",
    instDesc: "إدارة المساجد/ الدعوة والارشاد",
    instF1: "كل ميزات المنظمة",
    instF2: "حتى 50 حساباً للخطباء",
    ...
    ctaSub: "خطّط لـ 64 خطبة عبر 4 فصول. اكتب وأعدّ وألقِ كل خطبة بهدف.",
    ctaButton: "ابدأ مجاناً",

    math1Unit: "فصول",
    math1Per: "في السنة",
    math1Note: "13 أسبوعاً (جمعة) لكل فصل.",
    ...
    why64Label: "لماذا 64 وليس 52؟",
    why64Title: "تملك أربعاً وستين فرصة.",
    why64Text1: "اثنان وخمسون أسبوعاً، واثنتان وخمسون خطبة جمعة، وتُزاد عليها اثنتا عشرة خطبة للمناسبات الهجرية: عيد الفطر، وعيد الأضحى، والهجرة النبوية، والإسراء والمعراج، ومعركة بدر... الخ تأتي هذه في تواريخها، ولا تندرج بالضرورة تحت عنوانٍ من عناوينك أو باقةٍ من باقاتك. 52 + 12 = 64.",
    ...
    stat64Note: "الخطة السنوية كاملة: 52 + 12.",
    ...
    indBadge: "خطيب منفرد",
    orgBadge: "الجمعية ومساجدها ومصلياتها",
